    ...
    <html lang='en'>
        ...
        <body>
            <div class='cointainer homepage'>";   
                        ...
                        <div class='filters-wrapper'>
                            <div class='area-filters' id='filter-area'>
                                <div class='filter-wrapper' >
                                    ...
                                    <input list='filter-states' name='filter-state' id='filter-state' placeholder='Select State' >
                                    ...
                                    <input list='filter-city' name='filter-cities' id='filter-cities' placeholder='Select City'>
                ...
                $displayProductsQuery = "SELECT * FROM `products` WHERE `end_date` < CURRENT_DATE AND`seller_state` = $buyerState AND `seller_city` = '$buyerCity'; ";
                    ...
                    while( $product = mysqli_fetch_assoc($validRangeOfProducts)) {
                        ...
                        <div class='product'>
                            <div class='details-wrapper'>
                                ...
                                if ( strlen( $product['product_description']) > 45 ) { echo substr($productDetail['product_description'], 0, 45). "...</span>"; } 
                                else { echo $productDetail['product_description'] ."...</span>"; }
